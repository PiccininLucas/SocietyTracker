...
export const EditPlayerModal: React.FC<EditPlayerModalProps> = ({
  ...
  // No portal, como os outros modais: dentro do <main> (relative z-10) ele ficava embaixo
  // do cabeçalho e da navegação de baixo. O Esc não fecha no meio do salvamento.
  return (
    <ModalPortal
      label="Editar atleta"
      onClose={() => {
