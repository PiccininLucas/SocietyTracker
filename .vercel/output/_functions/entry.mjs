...
var middlewareSecret = "7e2690f5-d188-4738-8706-e4647e647fd0";
//#endregion
...
var entrypoint_default = { async fetch(request) {
	...
	else if (url.searchParams.get("x_astro_path_token") === "7e2690f5-d188-4738-8706-e4647e647fd0") realPath = url.searchParams.get(ASTRO_PATH_PARAM);
